...
main.out: main.o liquid_crystal_i2c.o i2c_master.o
	avr-gcc -Os -DF_CPU=16000000UL -mmcu=atmega328p i2c_master.o liquid_crystal_i2c.o main.o -o main.out
...
clean:
	rm i2c_master.o liquid_crystal_i2c.o main.hex main.o main.out